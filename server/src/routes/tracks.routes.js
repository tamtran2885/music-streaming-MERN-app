...
tracksRoutes.put("/like/:trackId", middleware.decodeToken, addFavToTrack);

// Remove Fav from a track
// @route PUT api/tracks/unlike/:trackId
tracksRoutes.put("/unlike/:trackId", middleware.decodeToken, removeFavFromTrack);

// Add track to playlist
// @route PUT api/tracks/addToPlaylist/:trackId
tracksRoutes.put("/addToPlaylist/:trackId", middleware.decodeToken, addTrackToPlaylist);
...
tracksRoutes.put("/reproducing/:trackId", middleware.decodeToken, reproductionsCounter);

// ? GET Tracks By User - firebaseUser
tracksRoutes.get("/likedByUser/:userId", middleware.decodeToken, getTrackDetailsInFav);

// ? GET TRACKS
tracksRoutes.get("/", middleware.decodeToken, getTracks);

// ? CREATE tracks
tracksRoutes.post("/", middleware.decodeToken, uploadTrack.single("urlTrack"), createTrack);
...
// ? DELETE tracks BY ID
tracksRoutes.delete("/:trackId", middleware.decodeToken, deleteTrack);

// ? ADD TRACK TO ALBUM
tracksRoutes.put("/addToAlbum/:trackId", middleware.decodeToken, trackToAlbum);
