...
const User = ({
  ...
  useEffect(() => {
    ...
    if (token) {
      setTimeout(async () => {
        ...
        dispatch(getAlbumsByUser(userId));
      }, 1000);
    }
  }, [dispatch]);
  ...
  useEffect(() => {
    ...
    setCreatedAlbums(myAlbums);
  }, [myTracks, myPlaylists, favTracksByUser, myFollowingPlaylists, myAlbums]);
          ...
          <div className="content__display">
            <div className="created__content">
              <div className="created__content__container">
                <h2 className="created__content__tittle">Created Playlists</h2>
                <img src={upload} alt="Create a playlist" className="upload" />
              </div>
              ...
              <div className="created__content__container">
                <h2 className="created__content__tittle">Uploaded Songs</h2>
                <img src={upload} alt="Update a song" className="upload" />
              </div>
              <div className="created__content__songs">
                {uploadTracks &&
                  uploadTracks.map((track) => (
                    <div className="song__absolute">
                      ...
                      <div className="song__reproductions">
              ...
              <div className="created__content__container">
                <h2 className="created__content__tittle">Created Albums</h2>
                <img src={upload} alt="Create a playlist" className="upload" />
              </div>
              ...
              {createdAlbums &&
                createdAlbums.map((album) => (
                  <div
                    className="created__content__playlist"
                    style={{
                      background: `url(${album.thumbnail}) no-repeat center center`,
                    }}
                  >
                    <p className="playlist__tittle">{album.title}</p>
                  </div>
                ))}
            </div>
            <div className="created__content">
              <div className="created__content__container">
                <h2 className="created__content__tittle">
                  Following Playlists
                </h2>
              </div>
              <div className="created__content__playlists">
              ...
              <div className="created__content__container">
                <h2 className="created__content__tittle">Favorite Songs</h2>
              </div>
              <div className="created__content__songs">
                {favTracks &&
                  favTracks.map((track) => (
              ...
              <div className="created__content__container">
                <h2 className="created__content__tittle">Liked Albums</h2>
              </div>
              <p>Here show Albums</p>
            </div>
          </div>
