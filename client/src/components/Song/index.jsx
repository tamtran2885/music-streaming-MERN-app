...
import { addLike, removeLike, getAllTracks, getTracksByUser, addReproductionsCounter, getFavTracksByUser } from "../../redux/track/actions";
...
const Song = ({track}) => {
  ...
  const { title, album, reproductions, genre, artist, _id, likes, photoTrack } = track
