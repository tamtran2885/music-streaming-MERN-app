...
const PlaylistTrackRow = ({ track, playlistInfo }) => {
  ...
  const { title, album, photoTrack, genre, artist, likes, _id, reproductions } = track;
  ...
  return (
    <div className="trackrow">
      <div className="song__image__container">
        <button className="song__button" onClick={handleClick}>
          <img
            ...
            src={photoTrack ? photoTrack : defaultPhotoTrack}
      ...
      <div className="song__info">
        <p className="song__tittle">{title ? title : "N/A"}</p>
        <p className="song__artist">
          {artist ? artist : "N/A"} · {genre ? genre : "N/A"}
        </p>
      </div>
