...
const EditTrackRow = ({
  ...
  return (
    <div className="trackrow">
      ...
      <div className="song__popularity">{editFormData.reproductions}</div>
      <div className="song__duration">{editFormData.duration}</div>
      <div className="song__edit__container check">
        <button className="song__edit__button" type="submit">
          <img className="song__edit__icon" src={check} alt="Check" />
        </button>
        <button
        ...
        >
          <img className="song__edit__icon" src={cancel} alt="Cancel" />
        </button>
      </div>
    </div>
  );
